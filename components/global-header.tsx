...
export function GlobalHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between border-b border-slate-200 bg-white px-4 py-3 backdrop-blur-xl dark:border-white/10 dark:bg-black/40">
      <div className="flex items-center gap-2">
        {inRoom && (
          <button
            type="button"
            aria-label="방 메뉴 토글"
            className="flex h-8 w-8 items-center justify-center rounded-md border border-slate-200 bg-slate-100 text-slate-700 hover:border-slate-300 hover:text-slate-900 dark:border-white/10 dark:bg-black/40 dark:text-slate-200 dark:hover:border-white/40 dark:hover:text-white"
        ...
        {inRoom && sessionTitle ? (
          <span className="ml-2 max-w-[160px] truncate text-sm text-slate-600 sm:max-w-xs dark:text-slate-200/80">
            {sessionTitle}
          </span>
        ) : null}
      </div>
            ...
            {user ? (
              <div className="space-y-1">
                ...
                <button
                  ...
                  disabled={loading}
                  className="flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm text-slate-700 hover:bg-slate-100 disabled:opacity-50 dark:text-slate-200 dark:hover:bg-slate-800"
                >
